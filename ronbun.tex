...
これらの先行研究から,IoTデータ管理においては,データ本体を分散ストレージに保存し,
ブロックチェーンはデータの参照情報や検証情報の管理に限定して用いることが,スケーラビリティと信頼性の両立に有効であることが分かる.
一方で,データの所有者や提供者の真正性については,主に公開鍵の対応関係に基づいて管理されており,
分散環境における主体識別や検証の標準化については十分に議論されていない.
